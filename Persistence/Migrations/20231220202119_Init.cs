...
namespace Persistence.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "Adress", "City", "Country", "Name", "PostalCode" },
                values: new object[,]
                {
                    { 1, "Bulevar Oslobodjenja 113", "Beograd", "Srbija", "Softcom", "11000" },
                    { 2, "Mihajla Pupina 22", "Beograd", "Srbija", "Greenstate Development", "11000" },
                    { 3, "Kosovksa 135", "Novi Sad", "Srbija", "Livonia", "21000" }
                });
